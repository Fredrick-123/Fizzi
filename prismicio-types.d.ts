...
/**
 * Primary content in *SkyDive1 → Default → Primary*
 */
export interface SkyDive1SliceDefaultPrimary {
  /**
   * Sentence field in *SkyDive1 → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: sky_dive1.default.primary.sentence
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  sentence: prismic.KeyTextField;

  /**
   * Flavor field in *SkyDive1 → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **Default Value**: lemonLime
   * - **API ID Path**: sky_dive1.default.primary.flavor
...
/**
 * Default variation for SkyDive1 Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type SkyDive1SliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<SkyDive1SliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *SkyDive1*
 */
type SkyDive1SliceVariation = SkyDive1SliceDefault;

/**
 * SkyDive1 Shared Slice
 *
 * - **API ID**: `sky_dive1`
 * - **Description**: SkyDive1
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type SkyDive1Slice = prismic.SharedSlice<
  "sky_dive1",
  SkyDive1SliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      SkyDive1Slice,
      SkyDive1SliceDefaultPrimary,
      SkyDive1SliceVariation,
      SkyDive1SliceDefault,
    };
  }
}
